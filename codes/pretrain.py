...
if __name__ == '__main__':
    ...
    parser.add_argument('--run_name', type=str, help="name for tensorboard run", default='chembl_pretrain')
    ...
    if args.dataset == "zinc":
        ...
        data = []
        file = open("data/GuacaMol/guacamol_v1_all.smiles", "r")
